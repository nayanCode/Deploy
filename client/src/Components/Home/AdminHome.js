...
const AdminHome = () => {
    ...
    const onDataTransfer=(dataTable)=>{
      setData(dataTable);
    };
  ...
  const handleDrawerClose = () => {
    ...
    return(
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['Admin Form', 'Verify'].map((text, index) => (
            <ListItem key={text} onClick={() => RenderComponent(index)} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                >
                  {index  === 0 ? <InboxIcon /> :"" || index  === 1  ?<VerifiedUserIcon/>:""  }
                </ListItemIcon>
      ...
      <Box component="main" sx={{ flexGrow: 1, p:2 }}>
        <DrawerHeader />      
        {
         listClicked==='verify' && <Verify onDataTransfer={onDataTransfer} />
       } 
        {
         listClicked==='form' && <Form prefill={data}/>
       }
      </Box>
        </Box>
    )
